...
- 👥 **User Management** - Complete user management ui
- 🛍️ **Product Management ** - users products tracking and management
...
3. Add your config to `src/Firebase/firebase.js`:
   ## OR
   Test email- admin1@gmail.com
   Test Password - 22222222     
